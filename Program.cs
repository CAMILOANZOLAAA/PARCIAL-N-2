...
int validacion(int codigo_estudiante);
void entar();
int id_profesor;
int menu_estudiante();
int clave;
...
int main()
{
  ...
  (
    int menu 
    printf('Bienvenido colegio Liceo Alta Blanca /n');
    printf('N°1.profesor \n N°2.Estudiante \n N°3.salir \n' );
    scanf ('%d', &Inicio)
    switch (Inicio)
